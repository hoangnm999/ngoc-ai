...
// 1. Tách logic xử lý SearchParams vào một component con
...
// 2. Component chính bọc nội dung trong Suspense
    ...
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24 }}>
      <Suspense fallback={
        <div style={{ textAlign: 'center' }}>
          <Spinner size={40} />
          <p style={{ marginTop: 20, color: 'var(--text-3)', fontSize: 13 }}>Đang tải...</p>
        </div>
      }>
